...
JanetAbstractType curl_obj = {"curl",
                              curl_gc_fn,
                              curl_mark_fn,
                              curl_get_fn,
                              JANET_ATEND_GET
                             };
JanetAbstractType curlsh_obj = {"curlsh",
                                curlsh_gc_fn,
                                NULL,
                                curlsh_get_fn, JANET_ATEND_GET
                               };
JanetAbstractType url_obj = {"url",
                             url_gc_fn,
                             NULL,
                             url_get_fn,
                             JANET_ATEND_GET
                            };
JanetAbstractType mime_obj = {"mime",
                              mime_gc_fn,
                              NULL,
                              mime_get_fn,
                              JANET_ATEND_GET
                             };
JanetAbstractType mimepart_obj = {"mimepart",
                                  JANET_ATEND_NAME
                                 };
